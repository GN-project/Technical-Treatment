      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-light text-dark" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php endif; ?>
            <?php else: ?>
              <a href="./admin" class="mx-2 text-dark"><b>Admin</b> Login</a>
            <?php endif; ?>
          </div>
        </div>
      </nav>
      <nav class="main-header navbar navbar-expand navbar-dark border-0 text-sm bg-gradient-blue" id='top-Nav'>
