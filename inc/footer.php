...
<footer class="main-footer text-base">
  <div class="container">
        <strong>Copyright © <?php echo date('Y') ?> <?php echo $_settings->info('short_name') ?>
        <!-- <a href=""></a> -->
        </strong>
        All rights reserved.
        ...
        <div class="float-right d-none d-sm-inline-block">
          ...
          <a href="https://mail.google.com" target=""><i class="far fa-envelope"></i></a> 
          <a href="https://twitter.com/?login"><i class="fab fa-twitter"></i></a> 
          <a href="https://web.whatsapp.com"><i class="fab fa-whatsapp"></i></a> 
          <a href="https://in.youtube.com/"><i class="fab fa-youtube"></i></a> 
